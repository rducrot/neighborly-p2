#--------- Flask settings
SERVER_HOST = 'https://neighborly-p2.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://neighborlyapi-project2.azurewebsites.net/api"
